...
.shopping-cart-table input[type="text"], .shopping-cart-table input[type="email"], .shopping-cart-table textarea {
    width: 100%;
    padding: 10px;
    margin-bottom: 20px;
...
<body class="cnt-home">
    ...
    <div class="container">
        <div class="breadcrumb-inner">
            <ul class="list-inline list-unstyled">
                ...
                <li class='active' style="color: #4169E1; font-weight: bold;">CONTACT US</li>
            </ul>
    ...
    <div class="body-content outer-top-xs" style="padding: 20px; background-color: #f9f9f9;">
    <div class="container" style="max-width: 600px; margin: 0 auto;">
        <div class="row inner-bottom-sm">
            <div class="col-md-12 col-sm-12 shopping-cart-table" style="background-color: #fff; border: 1px solid #ddd; border-radius: 8px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); padding: 20px;">
                <div class="table-responsive">
                    <form action="contact_process.php" method="post">
                        <div class="col-md-12">
                            <div class="form-group">
                                <h2 style="text-align: center; color: #4169E1;">Contact Us</h2>
                                ...
                                <input type="submit" id="same" value="Submit" style="background-color: #4CAF50; color: #fff; padding: 10px 15px; border: none; border-radius: 5px; cursor: pointer; font-size: 16px; transition: background-color 0.3s;">
                            </div>
                        </div>
                    </form>
                </div>
...
<script>
    const same = document.getElementById('same'); // Corrected method name
same.addEventListener('click', () => { // Corrected method name
    alert('YOUR REQUEST IS SENTED ');
});
</script>
