    ...
    <div class="container">
        <div class="breadcrumb-inner">
            <ul class="list-inline list-unstyled">
                ...
                <li class='active' style="color: #4169E1; font-weight: bold;">PAYMENT MERHOD</li>
            </ul>
...
<div class="panel panel-default checkout-step-01">
    ...
    <div class="col text-center">
        <input type="submit" name="submit" style="background-color: blue; color: white; border: none; padding: 10px 20px; cursor: pointer;" id="cod" value="Submit">
    </div>
</form>
<!-- checkout-step-01  -->
...
<?php include('includes/footer.php');?>
	...
	<script>
		...
		const cod = document.getElementById('cod'); // Corrected method name
cod.addEventListener('click', () => { // Corrected method name
    alert('YOUR ODER IS PLACED SUSSECCFULLY ');
});
